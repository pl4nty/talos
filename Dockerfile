...
# NOTE: igzip riscv64 is very new, and was slower than pigz for arm64, so we use pigz
COPY --link --from=pkg-zlib-riscv64 / /rootfs
COPY --link --from=pkg-pigz-riscv64 / /rootfs
